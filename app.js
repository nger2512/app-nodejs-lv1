...
mongoose.connect(`mongodb+srv://${databaseConfig.username}:${databaseConfig.password}@cluster0.yihfz.mongodb.net/${databaseConfig.database}?retryWrites=true&w=majority`);
